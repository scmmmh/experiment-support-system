...
def test_question_type_export():
    question_type = QuestionType(id=1)
    data, errors = QuestionTypeIOSchema().dump(question_type)
    assert data == {'data': {'type': 'question_types',
                             'id': '1',
                             'attributes': {}}}
    ...
    loaded, errors = schema.load({'data': {'type': 'question_type_groups',
                                  ...
                                  'included': [{'type': 'question_type_groups',
                                                ...
                                                'attributes': {'title': 'Builtin Questions',
                                                               ...
                                                               'order': 2,
                                                               'enabled': True}}]})
    assert isinstance(loaded, QuestionTypeGroup)
