...
def no_name_test():
    ...
    ok_(not number_input(element, {'did': 1}))
...
def number_input_test():
    ...
    tags = number_input(element, {'did': 1, 'name': 'Mark'})
    eq_('<section class="question number"><hgroup><h1>Specify a number, Mark</h1></hgroup><input type="number" name="items.1.number" /></section>',
    ...
    tags = number_input(element, {'did': 1, 'name': 'Mark', 'step': 1})
    eq_('<section class="question number"><hgroup><h1>Specify a number, Mark</h1></hgroup><input max="4" step="1" type="number" name="items.1.number" min="2" /></section>',
        tags.generate().render('xhtml'))
...
def email_input_test():
    ...
    tags = email_input(element, {'did': 1})
    eq_('<section class="question email"><hgroup><h1>Please provide your e-mail address</h1></hgroup><input type="email" name="items.1.email" /></section>',
        tags.generate().render('xhtml'))
...
def url_input_test():
    ...
    tags = url_input(element, {'did': 1})
    eq_('<section class="question url"><hgroup><h1>My homepage</h1></hgroup><input type="url" name="items.1.url" /></section>',
        tags.generate().render('xhtml'))
...
def date_input_test():
    ...
    tags = date_input(element, {'did': 1})
    eq_('<section class="question date"><hgroup><h1>Please provide your birthday</h1></hgroup><input type="date" name="items.1.birthday" /></section>',
        tags.generate().render('xhtml'))
...
def time_input_test():
    ...
    tags = time_input(element, {'did': 1})
    eq_('<section class="question time"><hgroup><h1>Please provide the current time</h1></hgroup><input type="time" name="items.1.time" /></section>',
        tags.generate().render('xhtml'))
...
def datetime_input_test():
    ...
    tags = datetime_input(element, {'did': 1})
    eq_('<section class="question datetime"><hgroup><h1>Please provide the current date and time</h1></hgroup><input type="datetime" name="items.1.now" /></section>',
        tags.generate().render('xhtml'))
...
def month_input_test():
    ...
    tags = month_input(element, {'did': 1})
    eq_('<section class="question month"><hgroup><h1>Please provide the current month</h1></hgroup><input type="month" name="items.1.month" /></section>',
        tags.generate().render('xhtml'))
...
def short_text_input_test():
    ...
    tags = short_text_input(element, {'did': 1})
    eq_('<section class="question short_text"><hgroup><h1>What is your name?</h1></hgroup><input type="text" name="items.1.name" /></section>',
        tags.generate().render('xhtml'))
...
def long_text_input_test():
    ...
    tags = long_text_input(element, {'did': 1})
    eq_('<section class="question long_text"><hgroup><h1>Briefly describe yourself</h1></hgroup><textarea name="items.1.description"></textarea></section>',
        tags.generate().render('xhtml'))
...
def rating_group_test():
    ...
    tags = rating_group(element, {'did': 1})
...
def multichoice_test():
    ...
    tags = multichoice(element, {'did': 1})
...
def multichoice_group_test():
    ...
    tags = multichoice_group(element, {'did': 1})
...
def confirm_test():
    ...
    tags = confirm(element, {'did': 1})
    eq_('<section class="question confirm"><hgroup><h1>Please confirm this</h1></hgroup><input type="checkbox" name="items.1.confirmation" value="true" id="items.1.confirmation" /><label for="items.1.confirmation">Please confirm this</label></section>',
        tags.generate().render('xhtml'))
    ...
    tags = confirm(element, {'did': 1})
    eq_('<section class="question confirm"><hgroup><h1>Please confirm this</h1></hgroup><input type="checkbox" name="items.1.confirmation" value="true" id="items.1.confirmation" /><label for="items.1.confirmation">I confirm this</label></section>',
        tags.generate().render('xhtml'))
    element = fromstring('<pq:confirm name="confirmation" xmlns:pq="http://paths.sheffield.ac.uk/pyquest"/>')
    tags = confirm(element, {'did': 1})
    eq_('<section class="question confirm"><input type="checkbox" name="items.1.confirmation" value="true" id="items.1.confirmation" /></section>',
        tags.generate().render('xhtml'))
