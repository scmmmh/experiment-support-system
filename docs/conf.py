# -*- coding: utf-8 -*-
#
# Experiment Support System documentation build configuration file, created by
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.intersphinx', 'sphinx.ext.numfig']
...
project = u'Experiment Support System'
