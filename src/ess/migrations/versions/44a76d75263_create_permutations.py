...
def upgrade():
    ...
    op.create_table('data_set_relations',
                    sa.Column('id', sa.Integer, primary_key=True),
                    sa.Column('subject_id', sa.Integer, sa.ForeignKey('data_sets.id',
                                                                      name='data_set_relations_subject_id_fk')),
                    sa.Column('object_id', sa.Integer, sa.ForeignKey('data_sets.id',
                                                                     name='data_set_relations_object_id_fk')),
