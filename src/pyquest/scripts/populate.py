...
<pq:question>
  ...
  <pq:attribute name="further.allow_other">no</pq:attribute>
        ...
        data_item.attributes.append(DataItemAttribute(order=1, value='This is the first item'))
        data_item.attributes.append(DataItemAttribute(order=2, value='http://www.example.com/1.html'))
        dataset.items.append(data_item)
        data_item = DataItem(order=2)
        data_item.attributes.append(DataItemAttribute(order=1, value='This is the second item'))
        data_item.attributes.append(DataItemAttribute(order=2, value='http://www.example.com/2.html'))
        dataset.items.append(data_item)
        data_item = DataItem(order=3, control=True)
        data_item.attributes.append(DataItemAttribute(order=1, value='This is the third item'))
        data_item.attributes.append(DataItemAttribute(order=2, value='http://www.example.com/3.html'))
        data_item.control_answers.append(DataItemControlAnswer(answer='0', question=question))
        dataset.items.append(data_item)
        data_item = DataItem(order=4)
        data_item.attributes.append(DataItemAttribute(order=1, value='This is the fourth item'))
        data_item.attributes.append(DataItemAttribute(order=2, value='http://www.example.com/4.html'))
        dataset.items.append(data_item)
        data_item = DataItem(order=5)
        data_item.attributes.append(DataItemAttribute(order=1, value='This is the fifth item'))
        data_item.attributes.append(DataItemAttribute(order=2, value='http://www.example.com/5.html'))
        dataset.items.append(data_item)
        data_item = DataItem(order=6)
        data_item.attributes.append(DataItemAttribute(order=1, value='This is the sixth item'))
        data_item.attributes.append(DataItemAttribute(order=2, value='http://www.example.com/6.html'))
        dataset.items.append(data_item)
        data_item = DataItem(order=7, control=True)
        data_item.attributes.append(DataItemAttribute(order=1, value='This is the seventh item'))
        data_item.attributes.append(DataItemAttribute(order=2, value='http://www.example.com/7.html'))
        data_item.control_answers.append(DataItemControlAnswer(answer='4', question=question))
        dataset.items.append(data_item)
        data_item = DataItem(order=8)
        data_item.attributes.append(DataItemAttribute(order=1, value='This is the eighth item'))
        data_item.attributes.append(DataItemAttribute(order=2, value='http://www.example.com/8.html'))
        dataset.items.append(data_item)
        data_item = DataItem(order=9)
        data_item.attributes.append(DataItemAttribute(order=1, value='This is the ninth item'))
        data_item.attributes.append(DataItemAttribute(order=2, value='http://www.example.com/9.html'))
        dataset.items.append(data_item)
        data_item = DataItem(order=10)
        data_item.attributes.append(DataItemAttribute(order=1, value='This is the tenth item'))
        data_item.attributes.append(DataItemAttribute(order=2, value='http://www.example.com/10.html'))
        dataset.items.append(data_item)
