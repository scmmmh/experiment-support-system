...
<pq:question>
  ...
  <pq:attribute name="further.allow_other">no</pq:attribute>
        ...
        dia = DataItemAttribute(order=1, value='This is the first item')
        data_item.attributes.append(dia)
        key_one.data_item_attributes.append(dia)
        dia = DataItemAttribute(order=2, value='http://www.example.com/1.html')
        data_item.attributes.append(dia)
        key_two.data_item_attributes.append(dia)
        dataset.items.append(data_item)

        data_item = DataItem(order=2)
        dia = DataItemAttribute(order=1, value='This is the second item')
        data_item.attributes.append(dia)
        key_one.data_item_attributes.append(dia)
        dia = DataItemAttribute(order=2, value='http://www.example.com/2.html')
        data_item.attributes.append(dia)
        key_two.data_item_attributes.append(dia)
        dataset.items.append(data_item)

        data_item = DataItem(order=3, control=True)
        dia = DataItemAttribute(order=1, value='This is the third item')
        data_item.attributes.append(dia)
        key_one.data_item_attributes.append(dia)
        dia = DataItemAttribute(order=2, value='http://www.example.com/3.html')
        data_item.attributes.append(dia)
        key_two.data_item_attributes.append(dia)
        ...
        dia = DataItemAttribute(order=1, value='This is the fourth item')
        data_item.attributes.append(dia)
        key_one.data_item_attributes.append(dia)
        dia = DataItemAttribute(order=2, value='http://www.example.com/4.html')
        data_item.attributes.append(dia)
        key_two.data_item_attributes.append(dia)
        dataset.items.append(data_item)

        data_item = DataItem(order=5)
        dia = DataItemAttribute(order=1, value='This is the fifth item')
        data_item.attributes.append(dia)
        key_one.data_item_attributes.append(dia)
        dia = DataItemAttribute(order=2, value='http://www.example.com/5.html')
        data_item.attributes.append(dia)
        key_two.data_item_attributes.append(dia)
        dataset.items.append(data_item)

        data_item = DataItem(order=6)
        dia = DataItemAttribute(order=1, value='This is the sixth item')
        data_item.attributes.append(dia)
        key_one.data_item_attributes.append(dia)
        dia = DataItemAttribute(order=2, value='http://www.example.com/6.html')
        data_item.attributes.append(dia)
        key_two.data_item_attributes.append(dia)
        dataset.items.append(data_item)

        data_item = DataItem(order=7, control=True)
        dia = DataItemAttribute(order=1, value='This is the seventh item')
        data_item.attributes.append(dia)
        key_one.data_item_attributes.append(dia)
        dia = DataItemAttribute(order=2, value='http://www.example.com/7.html')
        data_item.attributes.append(dia)
        key_two.data_item_attributes.append(dia)
        ...
        dia = DataItemAttribute(order=1, value='This is the eighth item')
        data_item.attributes.append(dia)
        key_one.data_item_attributes.append(dia)
        dia = DataItemAttribute(order=2, value='http://www.example.com/8.html')
        data_item.attributes.append(dia)
        key_two.data_item_attributes.append(dia)
        dataset.items.append(data_item)

        data_item = DataItem(order=9)
        dia = DataItemAttribute(order=1, value='This is the ninth item')
        data_item.attributes.append(dia)
        key_one.data_item_attributes.append(dia)
        dia = DataItemAttribute(order=2, value='http://www.example.com/9.html')
        data_item.attributes.append(dia)
        key_two.data_item_attributes.append(dia)
        dataset.items.append(data_item)

        data_item = DataItem(order=10)
        dia = DataItemAttribute(order=1, value='This is the tenth item')
        data_item.attributes.append(dia)
        key_one.data_item_attributes.append(dia)
        dia = DataItemAttribute(order=2, value='http://www.example.com/10.html')
        data_item.attributes.append(dia)
        key_two.data_item_attributes.append(dia)
        dataset.items.append(data_item)
