            ...
            if request.method == 'POST':
                try:
                    ...
                    with transaction.manager:
                        ...
                        permutations = todolist.getPermutations(params['task_worb'] + params['interface_worb'], params['task_count'], params['interface_count'], False, params['task_disallow'], params['interface_disallow'], True, params['task_order'])
...
def calculate_pcount(request):
    pcount = todolist.getPermutations(request.params['worb'], request.params['tcount'], request.params['icount'], False, request.params['tcon'], request.params['icon'], False, request.params['tord'])
