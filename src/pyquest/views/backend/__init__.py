...
def init(config):
    ...
    config.add_route('survey.data.new', '/surveys/{sid}/data/{disid}/new')
    ...
    config.add_route('data.edit', '/data/{did}/edit')
    config.add_route('data.delete', '/data/{did}/delete')
    config.add_route('survey.dataset.upload', '/surveys/{sid}/dataset/upload')
    config.add_route('survey.dataset.list', '/surveys/{sid}/dataset/list')
    ...
    config.add_route('survey.dataset.edit', '/surveys/{sid}/dataset/{disid}/edit')
    config.add_route('survey.dataset.delete', '/surveys/{sid}/dataset/{disid}/delete')
