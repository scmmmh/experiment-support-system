...
def init(config):
    ...
    config.add_route('survey.test', '/surveys/test')
    ...
    config.add_route('survey.data.new', '/surveys/{sid}/data/{did}/new')
    ...
    config.add_route('survey.dataset.edit', '/surveys/{sid}/dataset/{did}/edit')
    config.add_route('survey.dataset.delete', '/surveys/{sid}/dataset/{did}/delete')
