...
def init(config):
    ...
    config.add_route('data.item.new', '/dataitem/{dsid}/new')
    config.add_route('data.item.edit', '/dataitem/{did}/edit')
    config.add_route('data.item.delete', '/dataitem/{did}/delete')
